...
void exception_handler(int vector) {
	...
	switch(vector){
		case 0:
			tprint("fault: divide error\n");
			break;
		case 1:
			tprint("fault/trap: debug exception\n");
			break;
		case 2:
			tprint("Nonmaskable Interrupt\n");
			break;
		case 3:
			tprint("breakpoint\n");
			break;
		case 4:
			...
			break;
		case 5:
			tprint("BOUND range exceeded\n");
			break;
		case 6:
			tprint("Invalid opcode\n");
			break;
		case 7:
			tprint("device not available\n");
			break;
		case 8:
			tprint("Double fault\n");
			break;
		case 9:
			tprint("Coprocessor Segment Overrun\n");
			break;
		case 10:
			tprint("invalid TSS\n");
			break;
		case 11:
			tprint("Segment Not Present\n");
			break;
		case 12:
			tprint("stack-segment fault\n");
			break;
		case 13:
			tprint("General Protection\n");
			break;
		case 14:
			tprint("page fault\n");
			break;
		case 15:
			tprint("Intel Reserved\n");
			break;
		case 16:
			tprint("x87 FPU floating-point error\n");
			break;
		case 17:
			tprint("alignment check\n");
			break;
		case 18:
			tprint("machine check\n");
			break;
		case 19:
			tprint("SIMD Floating-Point Exception\n");
			break;
		case 20:
			tprint("Virtualization Exception\n");
			break;
	}
}
*/
